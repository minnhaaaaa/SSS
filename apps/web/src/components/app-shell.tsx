import { Activity, Gauge, Gavel, LayoutDashboard, PackageSearch, Radar, RefreshCw, ShieldCheck, UserRound } from "lucide-react";
...
const navigation = [
  ...
  { path: "/demo", label: "Live Proof", icon: Activity },
] as const;
...
export function AppShell() {
  ...
  const statusLabel = apiConnection === "online" ? "API CONNECTED" : "SYSTEM CHECK";
